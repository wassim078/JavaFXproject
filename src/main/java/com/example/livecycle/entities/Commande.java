...
public class Commande {
    ...
    private final StringProperty etatCommande = new SimpleStringProperty();
    ...
    public void setEtatCommande(String value) { etatCommande.set(value); }
    ...
    public String toString() {
        return String.format("Commande [ID=%d, Client=%s %s, Total=%.2f TND, État=%s]",
                getId(), getClientName(), getClientFamilyName(),
                getPrixTotal(), getEtatCommande());
    }
}